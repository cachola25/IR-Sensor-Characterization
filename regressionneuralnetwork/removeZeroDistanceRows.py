...
# Read the CSV file
input_file = "finalNewDataNoZeros.csv"  # Replace with your input file name
output_file = "finalNewDataNoTwelve.csv"  # Replace with your desired output file name
